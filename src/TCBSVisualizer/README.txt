...
This is the readme for TBCS, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. TBCS) > Ok.
...
- To run the project find TBCS.java (which will be in under src/main/java/com/mklprudence/tbcs) and right click > Run 'TBCS'
